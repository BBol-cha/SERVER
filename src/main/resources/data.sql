...
INSERT INTO board (id,uid,name,title,note,views,stitle,create_at,update_at,bimg) VALUES (1,1,"admin","제가 찾았던 문제입니다!",
"문제 내용 : 석구의 부모님은 TV에 나와 연일 대중들의 입방아에 오르내리고 있었다. 효진은 이런 석구의 부모님을 보고 “ 너희 부모님이 또 뉴스에 나오고 있어!” 라고 말해줬다. 이 말을 들은 석구는 더 슬퍼졌다. 왜 그랬을까?",
0, "테마는.. 미스터리","2022-12-09T11:49:13","2022-12-09T11:49:13","a.png");

INSERT INTO board (id,uid,name,title,note,views,stitle,create_at,update_at,bimg) VALUES (2,2,"user","이 문제 재밌네요",
...
0, "공포는 아니고 약간 소름?","2022-12-09T11:49:13","2022-12-09T11:49:13","b.png");

INSERT INTO board (id,uid,name,title,note,views,stitle,create_at,update_at,bimg) VALUES (3,1,"user","이게 실화라뇨..",
"문제 내용 : 청소원 A는 “누가 토마토 소스를 이렇게 많이 버린거야.” 생각했다. ",
0, "테마는.. 공포","2022-12-09T11:49:13","2022-12-09T11:49:13","c.png");
